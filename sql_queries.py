...
(songplay_id SERIAL PRIMARY KEY, start_time TIME(6), user_id INT, level VARCHAR, song_id VARCHAR, artist_id VARCHAR, session_id INT, location VARCHAR, user_agent VARCHAR)
""")
